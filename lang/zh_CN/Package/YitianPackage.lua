...
return {
	...
	["jiangboyue"] = "姜伯约",
	["lexue"] = "乐学",
	[":lexue"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令一名其他角色展示一张手牌：若此牌为非【闪】基本牌或非延时类锦囊牌，你于当前回合内可以将与此牌同花色的牌当作该牌使用或打出，以此法使用和打出时摸一张牌；否则，你获得之。",
	["xunzhi"] = "殉志",
	...
	["shenli"] = "神力",
	[":shenli"] = "<font color=\"blue\"><b>锁定技，</b></font>你于出牌阶段内使用【杀】或【决斗】<font color='red'>第一次</font>造成伤害时，此伤害+X（X为当前死战标记数且最大为3）。",
	...
	["zhanggongqi"] = "张公祺",
	["ytyishe"] = "义舍",
	[":ytyishe"] = "出牌阶段限一次，你可以与一名手牌数不大于你的其他角色交换手牌。",
	["ytmidao"] = "米道",
	[":ytmidao"] = "出牌阶段限一次，你可以令手牌数大于你的其他角色各交给你一张牌，然后若你的手牌数最多，你失去1点体力。",
	["ytmidao_ask"] = "【米道】请交给 %dest %arg 张牌",
	["ytpudu"] = "普渡",
	[":ytpudu"] = "限定技，出牌阶段，你可以获得所有其他角色的手牌，然后依次交给其他角色一张牌，直到你的手牌不为最多。",
	["ytpudu_ask"] = "【普渡】请交给 %dest %arg 张牌",
	["xiliang"] = "惜粮",
	...
	["panglingming"] = "庞令明",
	["taichen"] = "抬榇",
	[":taichen"] = "出牌阶段，你可以失去1点体力或弃置一张武器牌/防具牌，然后依次弃置你攻击范围内的一名角色区域内的两张牌。",
...
-- CV&Designer
	...
	["cv:zhanggongqi"] = "",
	["$ytyishe1"] = "上善若水，利万物而不争",
	["$ytyishe2"] = "圣人恒无心，以百姓心为心",
	["$ytmidao1"] = "知人者智，自知者明",
	["$ytmidao2"] = "自修其身，以臻仙寿",
	["$ytpudu1"] = "天地不仁，以万物为刍狗",
	["~zhanggongqi"] = "天之所恶，孰知其故",
