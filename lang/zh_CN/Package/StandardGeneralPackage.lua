...
return {
	...
	["jianxiong"] = "奸雄",
	[":jianxiong"] = "每当你受到伤害后，你可以选择一项：1.获得对你造成伤害的牌；2.摸X张牌（X为此次伤害的伤害数）；3.视为对一名其他角色使用【杀】（无距离限制且无视防具）。",
	["jianxiong:obtain"] = "获得伤害牌",
	["jianxiong:draw"] = "摸牌",
	["jianxiong:slash"] = "视为使用【杀】（无距离限制且无视防具）",
	["jianxiong-slash"] = "请选择一名其他角色，并视为对其使用【杀】（无距离限制且无视防具）",
	["zhishi"] = "治世",
	[":zhishi"] = "每名角色限两次。出牌阶段限一次，你可以对一名其他角色造成1点伤害，然后令其回复1点体力。",
	["zhishi-invoke"] = "【治世】对一名其他角色造成1点伤害，然后令其回复1点体力。",
	["hujia"] = "护驾",
	...
	["fankui"] = "反馈",
	[":fankui"] = "每当你受到1点伤害后，你可以令伤害来源失去所有技能直到其下个回合结束，然后获得伤害来源的一张牌。",
	["guicai"] = "鬼才",
	...
	[":yiji"] = "每当你受到1点伤害后，你可以摸两张牌，然后你可以将一至两张手牌交给至多两名其他角色。",
	--["@yiji"] = "你可以选择至多两名角色扣置“遗计牌”",
	["@yiji"] = "你可以选择至多两名角色，然后将一至两张手牌交给他们",
	--["YijiGive"] = "请在 %dest 武将牌旁扣置至多 %arg 张手牌",
	["YijiGive"] = "请交给 %dest 至多 %arg 张手牌",
	["~yiji"] = "选择一至两名角色→点击确定",
	...
	["rende"] = "仁德",
	[":rende"] = "出牌阶段，你可以将任意张手牌交给其他角色，然后你于此阶段以此法给出第二张手牌时，你回复1点体力。",
	--[":rende"] = "出牌阶段，你可以将任意张手牌交给其他角色，然后你于此阶段以此法给出第二张手牌时，你可以视为使用一张基本牌（视为使用【杀】有距离限制且计入出牌阶段使用限制）。",
	["@rende-give"] = "你可以发动“仁德”",
	["~rende"] = "选择至少一张手牌→选择一名其他角色→点击确定",
	["rende-basiccard"] = "你可以视为使用一张基本牌（视为使用【杀】有距离限制且计入出牌阶段使用限制）",
	["jijiang"] = "激将",
	...
	["wusheng"] = "武圣",
	["#wusheng-effect"] = "武圣",
	[":wusheng"] = "你可以将一张红色牌当普通【杀】使用或打出。锁定技，你使用红色牌无距离限制。",
	["yijue"] = "义绝",
	[":yijue"] = "阶段技。你可以与一名其他角色拼点：若你赢，该角色非锁定技无效，直到回合结束；若你没赢，你可以令该角色回复1点体力。",
	...
	["tishen"] = "替身",
	[":tishen"] = "限定技。准备阶段开始时，若你的体力值小于上回合结束时的体力值，你可以回复至上回合结束时的体力值，你每以此法回复1点体力则摸一张牌，然后获得技能“断吼”。",
	["$TishenAnimate"] = "image=image/animate/tishen.png",
	["duanhou"] = "断吼",
	[":duanhou"] = "你使用黑色牌仅指定一名其他角色为目标时，若你与其装备区牌差等于：1、本阶段你使用的牌数；2、本阶段你对其使用的牌数，你可以摸相同数量的牌。",
	...
	["tieji"] = "铁骑",
	[":tieji"] = "每当你指定【杀】的目标后，你可以进行判定：若为红色，你获得之并令此【杀】不可被闪避；若为黑色，你令该角色的非锁定技无效直到回合结束，然后令该角色弃置一张牌。",
	...
	["jizhi"] = "集智",
	[":jizhi"] = "每当你使用一张非转化的非延时锦囊牌时，你可以摸一张牌，然后若此时是你的回合内，你令本回合的手牌上限+1。",
	["@jizhi-exchange"] = "你可以用一张手牌替换展示的【%arg】",
	["qicai"] = "奇才",
	[":qicai"] = "锁定技。你使用锦囊牌无距离限制。其他角色不能弃置你装备区的非坐骑牌。",
	...
	["jiexi"] = "劫袭",
	[":jiexi"] = "你的回合内，其他角色的黑桃牌弃置时，你可以改为获得之。",
	["fenwei"] = "奋威",
	[":fenwei"] = "限定技。每当一名角色的非延时锦囊牌指定了至少两名目标时，你可以令此牌对至少一名目标角色无效，然后你摸同等数量的牌。",
	...
	[":keji"] = "锁定技，弃牌阶段开始时，若你未于本回合的出牌阶段内使用过颜色不同的牌，本回合你的手牌上限+4。",
	["stddujiang"] = "渡江",
	[":stddujiang"] = "觉醒技。准备阶段，若你的手牌数比体力值多3（七人及以上游戏为2）或更多，你弃置装备区所有的牌，然后可以将一名其他角色装备区的牌置入你的装备区，并获得“博图”。",
	["stddujiang-invoke"] = "【渡江】你可以将一名其他角色装备区的牌置入你的装备区",
	["~stddujiang"] = "选择一名装备区有牌的其他角色→点击确定",
	["qinxue"] = "勤学",
	...
	["zhouyu"] = "周瑜",
	["yingzi"] = "英姿",
	[":yingzi"] = "锁定技，摸牌阶段，你额外摸一张牌。你的手牌上限始终为你的体力上限。",
	["fanjian"] = "反间",
	...
	[":chuli"] = "阶段技。转换技，若你有牌，你可以：1、选择至少一名势力各不相同的有牌的其他角色：若如此做，你弃置你与这些角色各一张牌，然后以此法弃置黑桃牌的角色摸一张牌；2、弃置一张手牌，令一名已受伤的角色回复1点体力。",
	["jijiu"] = "急救",
	...
	["yaowu"] = "耀武",
	[":yaowu"] = "出牌阶段开始时，你可以亮出牌堆顶一张牌，然后其他角色依次选择是否获得此牌，若有角色选择是，视为其对你使用【决斗】，胜者获得此牌；若其他角色均选择否，你获得此牌。锁定技，你的初始手牌数+2。",
	["yaowu:recover"] = "回复1点体力",
	["yaowu:draw"] = "摸一张牌",
	["yaowu:ok"] = "获得此牌",
	["yaowu:cancel"] = "放弃",
	["stdshiyong"] = "恃勇",
	[":stdshiyong"] = "锁定技，你的非武器类装备牌均视为【决斗】。",
	...
	[":qiaomeng"] = "出牌阶段，你可以将一张【杀】或【酒】当【顺手牵羊】使用。",
