...
return {
	...
	["yinghun"] = "英魂",
	[":yinghun"] = "准备阶段/回合内第一次造成伤害时，你可以选择一名非当前回合角色并选择一项：1.令其摸X张牌，然后其弃置一张牌；2.令其摸一张牌，然后其弃置X张牌。（X为你已损失的体力值且至少为1）",
	["yinghun-invoke"] = "你可以发动“英魂”<br/> <b>操作提示</b>: 选择一名非当前回合角色→点击确定<br/>",
	["yinghun:d1tx"] = "摸一张牌，然后弃置X张牌",
	["yinghun:dxt1"] = "摸X张牌，然后弃置一张牌",
	["hunyou"] = "魂佑",
	[":hunyou"] = "限定技。结束阶段开始时，你可以选择不超过X名其他角色获得“佑”标记，然后失去等量体力（X为你的体力值-1），若如此做，与你同势力的其他角色准备阶段，你亦可发动“英魂”。有“佑”标记的角色受到伤害时，可以弃置此标记，防止该伤害。",
	["hunyou-prompt"] = "【魂佑】你可以选择不超过 %arg 名其他角色获得“佑”标记，然后失去等量体力",
	["~hunyou"] = "选择其他角色→点击确定",
	["hunyoup:ask"] = "【魂佑】是否弃置 1 枚“佑”标记，防止此次伤害",
	["#HunyouProtect"] = "%from 弃置了 1 枚“佑”标记，防止了 %arg 点伤害",
	["@hyou"] = "佑",
	...
	["weimu"] = "帷幕",
	[":weimu"] = "锁定技。你不能成为黑色锦囊牌的目标。防止你于回合内受到的伤害并摸两张牌。",
	["luanwu"] = "乱武",
	...
	["#WeimuPrevent"] = "%from 的锁定技【%arg2】被触发，防止了当前的 %arg 点伤害",
