...
return {
	...
	["spyicong"] = "义从",
	[":spyicong"] = "锁定技。若你的手牌数大于或等于体力值，你与其他角色的距离-1；若你的手牌数小于体力值，其他角色与你的距离+1。",
	["spzhulou"] = "筑楼",
	[":spzhulou"] = "回合结束阶段开始时，你可以摸/弃两张牌，若如此做，你的下个准备阶段开始时，你需弃/摸两张牌。",
	["spzhulou:draw"] = "摸两张牌，然后回合开始时弃两张牌",
	["spzhulou:discard"] = "弃两张牌，然后回合开始时摸两张牌",
	...
	["juesi"] = "决死",
	[":juesi"] = "其他角色使用的【杀】或普通锦囊牌仅指定你为目标时，你可以将其改为【决斗】。你可以将非基本手牌当【杀】使用或打出。",
	["juesi:invoke"] = "【决死】是否将 %src 对你使用的 %card 改为【决斗】？",
	["#JuesiLog"] = "%from 发动了“%arg”，将 %card 改为了【决斗】",
	...
	["danji"] = "单骑",
	[":danji"] = "觉醒技。准备阶段开始时，若你的手牌数大于体力值，且本局游戏主公不为刘备，你失去1点体力上限，回复2点体力，然后获得“马术”、“怒斩”和“水袭”。",
	["$DanjiAnimate"] = "image=image/animate/danji.png",
	["#DanjiWake"] = "%from 的手牌数 %arg 大于体力值 %arg2 ，且本局游戏主公不为刘备，触发“<font color=\"yellow\"><b>单骑</b></font>”觉醒",
	["shuixi"] = "水袭",
	[":shuixi"] = "阶段技。若你的手牌数不大于场上的牌，你可以选择一项：1、摸一张牌然后弃置一名其他角色区域内一张牌；2、弃置一名其他角色装备区的牌。",
	["shuixi:c1"] = "摸一张牌，弃置一名其他角色区域内一张牌",
	["shuixi:c2"] = "弃置一名其他角色装备区的牌",
	["#shuixi-invoke1"] = "【水袭】选择一名其他角色，弃置其区域内一张牌",
	["#shuixi-invoke2"] = "【水袭】选择一名其他角色，弃置其装备区的牌",
	["$shuixi1"] = "听听这江河的咆哮吧！",
	...
	[":yuanhu"] = "结束阶段开始时，你可以展示并交给一名其他角色一张基本牌，或将一张装备牌置于一名角色装备区内：若此牌为武器牌，你弃置该角色距离1的一名角色区域内的一张牌；若此牌为防具牌，该角色摸一张牌；若此牌为坐骑牌，该角色回复1点体力。若如此做，该角色每次回复体力、装备区获得或失去牌时，你与其各摸一张牌，直到你的回合开始。",
	...
	["#zhangbao"] = "地公将军",
	["zhangbao"] = "张宝",
	["illustrator:zhangbao"] = "zyy",
	["zhoufu"] = "咒缚",
	[":zhoufu"] = "你使用可造成伤害的牌指定唯一目标角色后，可以令其进行判定，若结果为红桃，你对其造成1点火焰伤害；方块，你摸两张牌；黑色，你获得此判定牌。若如此做，此牌造成伤害前，你防止此伤害，改为弃置即将受到伤害的角色两张牌。",
	["incantation"] = "咒缚",
	["yingbing"] = "影兵",
	[":yingbing"] = "若你于此阶段内使用或打出的上一张牌不以此方式且为基本牌或非延时锦囊牌，你可以将一张同颜色的牌当作之使用或打出。",
	...
	["yinbing"] = "引兵",
	[":yinbing"] = "当你攻击范围内的其他角色成为另一名其他角色使用【杀】的目标时，你可以获得其一张装备区的牌，然后将此【杀】转移给你。当你成为【杀】的目标时，你可以弃置一张牌，然后摸X张牌（X为你已损失的体力值且至多为5）。",
	["@yinbing"] = "你可以发动“引兵”",
	["yinbing_self"] = "【引兵】你可以弃置一张牌，然后摸X张牌（X为你已损失的体力值且至多为5）",
	["yinbing_other"] = "【引兵】你可以获得目标一张装备区的牌，然后将此【杀】转移给你",
	["yinbing_choose"] = "【引兵】请选择一张装备区的牌",
	["~yinbing"] = "选择一张牌→点击确定",
	["juedi"] = "绝地",
	...
	["juyi"] = "举义",
	[":juyi"] = "觉醒技。准备阶段开始时，若你已受伤且体力上限大于角色数，你摸等同于你体力上限数量的牌，然后获得“崩坏”和“威重”（锁定技。每当你的体力上限改变后，你摸一张牌）。",
	["weizhong"] = "威重",
	[":weizhong"] = "锁定技。每当你的体力上限改变后，你弃一张牌，然后摸两张牌。",
	...
	[":cihuai"] = "你使用仅指定一名其他角色为目标的【杀】结算后，可以进行判定，若为红色，则视为你对目标角色使用【杀】。",
	...
	["jspdanqi"] = "单骑",
	[":jspdanqi"] = "觉醒技。准备阶段开始时，若你的手牌数大于你的体力值且主公不为刘备，你减1点体力上限，回复2点体力，然后获得“马术”、“怒斩”和“水袭”。",
	["nuzhan"] = "怒斩",
	...
	["suiren"] = "随仁",
	[":suiren"] = "限定技。准备阶段开始时，你可以失去技能“义从”，获得“银枪”，然后加1点体力上限并回复1点体力，再令一名角色摸三张牌。",
	["@suiren-draw"] = "请选择“随仁”摸牌的角色",
	["yinqiang"] = "银枪",
	[":yinqiang"] = "你使用【杀】指定目标角色后，可以翻开牌堆顶一张牌，若为基本牌或锦囊牌，则你可以对其或自己使用之。" ,
	["yinqiang-invoke"] = "【银枪】你可以选择一名角色，然后对其使用 %card",
	...
	["sp_zhugeliang"] = "SP诸葛亮",
	["sanfen"] = "三分",
	[":sanfen"] = "阶段技。你可以选择至少一名其他角色，弃置X张牌，然后亮出牌堆顶X+1张牌，从你开始依次由你选择一张可使用的牌，然后对下一名角色使用之，直到无牌可用，你获得其余的牌。（X为选择的其他角色数）",
	["weiwo"] = "帷幄",
	[":weiwo"] = "锁定技。当你受到属性伤害/非属性伤害时，若你有手牌/没有手牌，防止此伤害。",
	["#WeiwoInfo"] = "%from 的“<font color=\"yellow\"><b>帷幄</b></font>”效果被触发，防止了 %arg 点伤害[%arg2]",
...
●装备牌，你使用【杀】指定目标角色后，其弃置两张牌。",
	...
	["spkuangfu"] = "狂斧",
	[":spkuangfu"] = "锁定技。你使用【杀】指定目标后，若目标角色：1、不闪避，此【杀】对其造成伤害+1；2、使用一张【闪】，此【杀】仍造成伤害，你对自身也造成1点伤害；3、使用两张【闪】，你对自身造成1点伤害。",
	["@spkuangfu-jink-start"] = "%src 使用了【杀】，你须连续使用 %arg 张【闪】，否则此【杀】对你造成伤害+1",
	["@spkuangfu-jink"] = "%src 使用了【杀】，你须再使用 %arg 张【闪】，否则此【杀】仍造成伤害",
	["#SPKuangfuEffect_1"] = "%from 的【狂斧】效果被触发， %to 没有闪避，伤害从 %arg 增加至 %arg2",
	["#SPKuangfuEffect_2"] = "%from 的【狂斧】效果被触发， %to 使用了一张【闪】，【杀】仍造成伤害，%from 将对自己造成1点伤害",
	["#SPKuangfuEffect_3"] = "%from 的【狂斧】效果被触发， %to 使用了两张【闪】，%from 将对自己造成1点伤害",
	["$spkuangfu1"] = "我的大斧早就饥渴难耐了！",
	["$spkuangfu2"] = "吾有上将潘凤，可斩华雄。",
