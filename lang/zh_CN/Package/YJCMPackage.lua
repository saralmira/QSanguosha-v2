...
return {
	...
	["enyuan"] = "恩怨",
	[":enyuan"] = "每当你获得一名其他角色的两张或更多的牌后，你可以令其摸一张牌。每当你受到1点伤害后，你可以令伤害来源选择一项：交给你一张手牌，或失去1点体力。若其交给你的牌不是红桃，你摸一张牌。",
	["EnyuanGive"] = "请交给 %dest %arg 张手牌",
	["xuanhuo"] = "眩惑",
	[":xuanhuo"] = "摸牌阶段开始时，你可以放弃摸牌并选择一名其他角色：若如此做，该角色摸两张牌，然后该角色可以对其攻击范围内由你选择的一名角色使用一张【杀】，否则令你获得其两张牌。",
	--[":xuanhuo"] = "摸牌阶段结束时，你可以将两张手牌交给一名其他角色，然后该角色选择一项：1.视为对你选择的另一名其他角色使用任意一种【杀】或【决斗】；2.交给你所有手牌。",
	["xuanhuo-prompt"] = "你可以发动“眩惑”将两张手牌交给一名其他角色。",
	["xuanhuo-prompt2"] = "选择一名其他角色，然后该角色选择一项：1.视为对你选择的另一名其他角色使用任意一种【杀】或【决斗】；2.交给你所有手牌。",
	...
	["illustrator:masu"] = "张帅",
	["xinzhan"] = "心战",
	[":xinzhan"] = "出牌阶段，你可以弃置一张红桃牌，然后摸X+1张牌（X为你已损失的体力值且至少为1）。",
	...
	[":pojun"] = "每当你使用【杀】指定目标角色后，你可以令其展示所有手牌，然后选择弃置其所有红色/黑色牌并令其摸等量的牌（至多为2）。",
	["pojun:red"] = "弃置所有红色牌",
	["pojun:black"] = "弃置所有黑色牌",
