CommonTranslationTable = {
	...
	["$TurnOverBottom"] = "%from 展示了牌堆底的 %card",
	...
	["$ShowHandCards"] = "%from 展示了手牌 %card",
	["$ViewHandCards"] = "%from 观看了 %to 的手牌 %card",
	...
	["#DrawNCardsBottom"] = "%from 从牌堆底摸了 %arg 张牌",
	["$DrawCardsBottom"] = "%from 从牌堆底摸了 %arg 张牌 %card",
	...
	["#GetTransformGeneral"] = "%from 抽取了武将牌 %arg",
