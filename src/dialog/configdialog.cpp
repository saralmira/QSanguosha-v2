    ...
    : QDialog(parent), ui(new Ui::ConfigDialog)
{
    ...
    ui->oneClickToChooseCheckBox->setChecked(Config.OneClickToChoose);
...
void ConfigDialog::saveConfig()
{
    ...
    Config.OneClickToChoose = ui->oneClickToChooseCheckBox->isChecked();
    Config.setValue("OneClickToChoose", Config.OneClickToChoose);
