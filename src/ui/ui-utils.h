...
namespace QSanUiUtils {
    ...
    void produceShadow(QPainter *painter, const QImage &image, QColor shadowColor, int radius, double decade, QRect &pos);
    void produceShadow(QGraphicsPixmapItem *pixmapItem, const QImage &image, QColor shadowColor, int radius, double decade, QRect &pos);
