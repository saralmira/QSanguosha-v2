...
StandardCardDialog *StandardCardDialog::getInstance(const QString &object, bool left, bool right,
    bool play_only, bool slash_combined, bool delayed_tricks)
{
    static StandardCardDialog *instance;
    if (instance == NULL || instance->objectName() != object)
        instance = new StandardCardDialog(object, left, right, play_only, slash_combined, delayed_tricks);

    return instance;
}

StandardCardDialog::StandardCardDialog(const QString &object, bool left, bool right, bool play_only,
...
bool StandardCardDialog::isButtonEnabled(const QString &button_name) const
{
...
void StandardCardDialog::selectCard(QAbstractButton *button)
{
...
QGroupBox *StandardCardDialog::createLeft()
{
...
QGroupBox *StandardCardDialog::createRight()
{
...
QAbstractButton *StandardCardDialog::createButton(const Card *card)
{
